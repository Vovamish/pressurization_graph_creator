...
class Graf_Bilder():
    ...
    def round_and_str(num, unit):
        ...
        return str_num
    def __init__(self, pressurization, unit_time = None, unit_pressure = None):
    ...
    def calculate_scale_for_graf(self):
        ...
        self.offset_axes_y = sin_45 * (max_time_text_size + self.gss_y()) + self.gap
    ...
    def draw_coordinates_axis(self, axes_stroke_width = 2, axis_points_r = 2.25):
        ...
        self.l_axis[0].set("y1", str(self.size_y-self.gap))
